    ...
    type: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                "'political' covers NYS/FEC/NYC donations, NYS state procurement, "
                "NYC city contracts, federal awards (USAspending), and power-map "
                "relationships from LittleSis (donations, lobbying, ownership). "
